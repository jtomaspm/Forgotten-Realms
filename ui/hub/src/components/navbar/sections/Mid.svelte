<script lang="ts">
    import { ChartMixedDollarSolid, HomeSolid, GlobeSolid, UsersSolid, InfoCircleSolid, ShoppingBagSolid } from 'flowbite-svelte-icons';
...
<style lang="postcss">
    ...
    div {
        @apply flex flex-col items-center gap-3 sticky top-1/2 transform -translate-y-1/2;
    }
</style>